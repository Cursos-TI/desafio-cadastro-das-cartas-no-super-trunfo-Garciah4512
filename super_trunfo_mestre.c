...
int main(){
    ...
    //Utilizando um if else para resolver problema da densidade populacional
    if(densidade_populacional1 < densidade_populacional2){
        super_poder1 = super_poder1 + densidade_populacional1;
        super_poder2 = super_poder2 - densidade_populacional2;
    }else{
        super_poder1 = super_poder1 - densidade_populacional1;
        super_poder2 = super_poder2 + densidade_populacional2;
    }

    //Batalha de cartas do Super_trunfo com comparações dentro do printf
